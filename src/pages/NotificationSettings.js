...
const NotificationSettings = () => {
  ...
  const Toggle = ({ value, onChange, disabled }) => (
    <button
      style={{
        ...styles.toggle,
        backgroundColor: value ? '#004B87' : '#e2e8f0',
    ...
    return (
      <div style={styles.container}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
          <div style={{ width: 32, height: 32, border: '3px solid #e2e8f0', borderTop: '3px solid #004B87', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
        </div>
      </div>
    );
  }
