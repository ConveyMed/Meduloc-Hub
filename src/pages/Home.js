    ...
    if (scrollTarget?.postId) {
      ...
      if (postElement) {
        ...
        setTimeout(() => {
          ...
          postElement.style.boxShadow = '0 0 0 3px #004B87';
          setTimeout(() => {
        ...
        {(pullDistance > 0 || isRefreshing) && (
          <div style={{
            ...
            <div style={{
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#004B87" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
