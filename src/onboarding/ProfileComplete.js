    ...
    <div className="profile-container">
      ...
      {step === 'welcome' && (
        <div className="profile-step">
          ...
          <p className="profile-subtitle">Let's set up your profile. What's your name? <span style={{color: '#004B87', fontWeight: '500'}}>(required)</span></p>
      ...
      {step === 'phone' && (
        <div className="profile-step">
          ...
          <p className="profile-subtitle">What's your phone number? <span style={{color: '#94a3b8'}}>(optional)</span></p>
      ...
      {step === 'title' && (
        <div className="profile-step">
          ...
          <p className="profile-subtitle">What's your job title? <span style={{color: '#94a3b8'}}>(optional)</span></p>
      ...
      {step === 'photo' && (
        <div className="profile-step">
          ...
          <p className="profile-subtitle">Help your team recognize you <span style={{color: '#94a3b8'}}>(optional)</span></p>
      ...
      {step === 'bio' && (
        <div className="profile-step">
          ...
          <p className="profile-subtitle">Write a short bio for your profile <span style={{color: '#94a3b8'}}>(optional)</span></p>
